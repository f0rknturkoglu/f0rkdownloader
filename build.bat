...
pyinstaller --onefile --name "f0rkn_d0wnl0ader" --console --add-data "src;src" --hidden-import "yt_dlp" --hidden-import "yt_dlp_ejs" --hidden-import "gallery_dl" --hidden-import "rich" --hidden-import "questionary" --hidden-import "pycryptodomex" --hidden-import "brotli" --collect-all "yt_dlp" --collect-all "gallery_dl" main.py
